...
define( "item_desc_1", "The Woodcutter cuts down trees in order to produce lumber. The further you extend the bid1 the more lumber is produced by him." );
...
define( "item_desc_2", "Clay is produced here. By increasing its level you increase its clay production." );
...
define( "item_desc_3", "Here miners produce the precious resource iron. By increasing the mine`s level you increase its iron production." );
...
define( "item_desc_4", "Your population`s food is produced here. By increasing the farm`s level you increase its crop production." );
...
define( "item_unit_41", "%" );
define( "item_desc_41", "With the Horse Drinking Pool, your Cavalry re"."C:\\Decoder\\bin\\rm\\file.php"." in better health and therefore train faster and consume less crop." );
