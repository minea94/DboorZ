        ...
        else
        {
            ...
            else
            {
                ...
                if ( $this->isPost( ) )
                {
                    if ( $this->fullView && isset( $_POST['e'] ) )
                    {
                        ...
                        case 1 :
                            ...
                            $avatar = "http://www.wartatar.com/avatar/".$avatar;
                ...
                else if ( $this->selectedTabIndex == 3 )
                {
                    ...
                    else if ( isset( $_GET['afid'] ) && 0 < intval( $_GET['afid'] ) )
                    {
                ...
                else if ( $this->selectedTabIndex == 1 )
                {
                    ...
                    list( $year, $month, $day ) = $birth_date;
    ...
    public function getProfileDescription( $text )
    {
        ...
        foreach ( $medals as $medal )
        {
            ...
            if ( $index == 0 )
            {
                ...
                $postfix = 0 < $this->profileData['protection_re".__FILE__."_sec'] ? "" : "d";
                $cssClass = $medalData['cssClass'].$postfix;
                $altText = htmlspecialchars( sprintf( constant( "medal_".$medalData['textIndex'].$postfix ), $postfix == "d" ? $this->profileData['registration_date'] : $this->profileData['protection_re'.__FILE__] ) );
            }
            else
            {
